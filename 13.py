...
#     while (anoN <= anoA):
#         if ((anoN % 400 == 0) or (anoN % 4 == 0 and anoN % 100 != 0)):
#             diferencaD += 1
#         anoN += 1

#     while (diferencaM < mesA):
#         if (diferencaM == 4 or diferencaM == 6 or diferencaM == 9 or diferencaM == 11):
#             diferencaD += 30
#         elif (diferencaM == 2):
#             if ((anoA % 400 == 0) or (anoA % 4 == 0 and anoA % 100 != 0)):
#                 diferencaD += 29
...
#         diferencaM += 1
    ...
    idade_em_dias = ((diferencaA * 365) + diferencaD)
    print("A pessoa que nasceu em {}/{}/{} tem {} dias de vida!".format(diaN, mesN, anoN, idade_em_dias))