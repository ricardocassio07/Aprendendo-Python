...
if (verificado == True):
    ...
    idade_em_dias = ((diferencaA * 365) + (diferencaM * 30) + diferencaD)
    print("A pessoa que nasceu em {}/{}/{} tem, aproximadamente, {} dias de vida!".format(diaN, mesN, anoN, idade_em_dias))